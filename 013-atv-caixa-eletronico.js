...
if (!acessoPermitido) {
    ...
    if (saldoUsuarioLogado > 0) {
        ...
        if (saldoParcial < 0) {
            console.log(`${usuarioLogado} você tem R$ ${saldoUsuarioLogado} e está tentando sacar R$ ${valorSaque}, seu saldo é insuficiente!`);
            ...
            if (controleNotas === 1) {
                console.log(`Não será possível efetuar o saque, pois não temos notas de R$ 1,00.`);
            } else {
